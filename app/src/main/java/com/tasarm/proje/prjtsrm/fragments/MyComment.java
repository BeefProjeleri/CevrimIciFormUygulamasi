 ...
 * {@link MyComment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link MyComment#newInstance} factory method to
...
public class MyComment extends Fragment {
     ...
     * @return A new instance of fragment MyComment.
     */
    // TODO: Rename and change types and number of parameters
    public static MyComment newInstance(String param1, String param2) {
        MyComment fragment = new MyComment();
    ...
    String isim;
    public void degis2(String isim){
        this.isim=isim;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        url_post=base+"/android/mycomment.php";
