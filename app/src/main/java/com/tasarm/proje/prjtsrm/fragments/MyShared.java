 ...
 * {@link MyShared.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link MyShared#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MyShared extends Fragment {
     ...
     * @return A new instance of fragment MyShared.
     */
    // TODO: Rename and change types and number of parameters
    public static MyShared newInstance(String param1, String param2) {
        MyShared fragment = new MyShared();
    ...
    String isim;
    public void degis1(String isim){
        this.isim=isim;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_my_shared, container, false);
        recyclerView=(RecyclerView)view.findViewById(R.id.rec2);
        String base=getString(R.string.adres);
        url_post=base+"/android/myshared.php";
